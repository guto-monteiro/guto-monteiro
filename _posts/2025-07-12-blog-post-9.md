...
<br>
Hello! Today I'll be your guide through the main workflow of Qiime2 (Which we use to attain ASVs).<br>  
<br>
...
### The qiime2meco() function in R is designed to create the microtable object using files from QIIME2 ([Bolyen et al. 2019](https://chiliubio.github.io/microeco_tutorial/file2meco-package.html#ref-Bolyen_Reproducible_2019)).  
